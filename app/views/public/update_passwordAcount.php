                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control" name="first_name" id="first_name"
                                                    placeholder="Ingrese el nombre" value="<?php echo $_SESSION['patient']->name ?> " disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control" name="last_name" id="last_name"
                                                    placeholder="Ingrese el apellido" value="<?php echo $_SESSION['patient']->last_name ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <input type="text" class="form-control" name="birthdate" id="birthdate"
                                                    ...
                                                    value="<?php echo date('Y-m-d', strtotime($_SESSION['patient']->birthdate))?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group form-inline">
                                               <label class="form-check-label" style="margin-right: 20px">
                                                    <input class="form-check-input" type="radio" name="gender" id="gender" value="1"
                                                       accept="text/html"
                                                       <?php echo $var = ($_SESSION['patient']->gender == 1)?'checked':'' ?> disabled>
                                                    Hombre
                                               ...
                                               <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="gender" id="gender" value="2"
                                                       accept="text/html"
                                                       <?php echo $var = ($_SESSION['patient']->gender == 2)?'checked':'' ?> disabled>
                                                    Mujer
                                                    <span class="form-check-sign"></span>
                                               </label>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                               ...
                                               <input type="email" class="form-control" name="email" id="email"
                                                    placeholder="Ingrese un correo" value="<?php echo $_SESSION['patient']->email ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
