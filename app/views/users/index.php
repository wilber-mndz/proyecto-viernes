            ...
            <?php foreach ($parameters['users'] as $key => $user):?>
                <tr>
                    ...
                    <td class="td-actions text-right">
                        <a href="<?php echo ROUTE_URL?>/users/update/<?php echo $user->id_user?>" rel="tooltip" class="btn btn-info btn-sm btn-round btn-icon">
                            <i class="fas fa-user-edit"></i>
                        </a>
                        <a href="<?php echo ROUTE_URL?>/users/change_password/<?php echo $user->id_user?>" rel="tooltip" class="btn btn-success btn-sm btn-round btn-icon">
                            <i class="fas fa-key"></i>
                        </a>
                        <a href="<?php echo ROUTE_URL?>/users/disable/<?php echo $user->id_user?>" rel="tooltip" class="btn btn-danger btn-sm btn-round btn-icon">
